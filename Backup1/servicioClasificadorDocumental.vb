...
#End Region
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        Try
            objEventLog.WriteEntry("Se esta iniciando el servicio de clasificador documental.")
    ...
    Protected Overrides Sub OnStop()
        ...
        objEventLog.WriteEntry("Se esta detubo el servicio de clasificador documental.")
    End Sub
    ...
    Private Sub temporizadorServicio_Elapsed(ByVal sender As System.Object, ByVal e As System.Timers.ElapsedEventArgs) Handles temporizadorServicio.Elapsed
        Dim objSingleton As ComponenteClasificadorDocumentos.ClassSingleton
        Dim objMonitoreo As New ComponenteClasificadorDocumentos.ClassMonitoreoDeCarpeta
        Try
            temporizadorServicio.Stop()
            ...
            If activoServicio = True Then
                ...
                objSingleton = New ComponenteClasificadorDocumentos.ClassSingleton(rutaArchivoConfig, rutaCompletaArchivoLog, rutaCompletaArchivoLogErrores, strEcontentServidor, strEcontentlibreria, strEcontentUser, strEcontentPWd, strIdCarpeta, strIdCarpetaError, idCarpetaPadreAlmacenamiento)
                objSingleton.objLog.grabarLogEnArchivoPlano("monitorearColaEcontent", "Se comienza a monitorear la carpeta.", ComponenteClasificadorDocumentos.ClassGeneradorLog.tipoLog.LogEjecucion)
        ...
        Catch ex As Exception
            ...
            Try
                objSingleton.objLog.grabarLogEnArchivoPlano("monitorearColaEcontent", ex.Message, ComponenteClasificadorDocumentos.ClassGeneradorLog.tipoLog.LogErrores)
                objSingleton.close()
...
#Region " Codigo de desarrollo para el SERVICIO de monitoreo de carpetas como tal. "
    ...
    Private Sub leerParametrosInicialesConfiguracion()
        ...
        Try
            Dim rutaArchivoConfig As String
            rutaArchivoConfig = System.Configuration.ConfigurationSettings.AppSettings.Get("config.xml")
            Dim objXML As New ComponenteClasificadorDocumentos.ClassLecturaXML(rutaArchivoConfig)
